...
${OBJECTDIR}/LangModel.o: LangModel.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LangModel.o LangModel.c
...
${OBJECTDIR}/oldmain.o: oldmain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/oldmain.o oldmain.cpp
